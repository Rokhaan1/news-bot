...
VOICE = (
    ...
    "EMPIRES (Ghurids, Khaljis, Lodis, Suris, Hotaks, Durranis rose FROM this "
    "soil and its peoples) — NEVER call it the 'graveyard of empires', a "
    "'crossroads', 'battleground', or 'path of empires'; that colonial framing "
    "shrinks a civilization into a footnote of other people's stories, and this "
    "account rejects it. Keep nationalism PAN-AFGHAN: celebrate the nation as one "
    "and do not single out any ethnicity (no ethnic-specific claims or framing, "
    "e.g. about Pashtuns), and never post contested demographic figures "
    "(population counts, ethnic percentages) as fact.\n"
